...
query = 'SELECT * FROM data_table2023'  # Adjust your query as needed
...
csv_file_path = 'extracted_data2023.csv'
...
df = pd.read_csv('extracted_data2023.csv')
...
df.to_csv('extracted_data2023_cleaned.csv', index=False)
